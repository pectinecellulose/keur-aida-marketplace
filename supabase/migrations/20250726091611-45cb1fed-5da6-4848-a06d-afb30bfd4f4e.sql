...
('Voitures', 'voitures', 'Voitures neuves et d\'occasion', '🚗', 'c08442b5-3ca9-4c37-a2db-f4f0560225fe', 1, true),
...
-- Optimiser les requêtes avec des vues matérialisées pour les statistiques
CREATE OR REPLACE VIEW ads_with_category AS
SELECT a.*, c.name as category_name, c.slug as category_slug, c.emoji as category_emoji
FROM ads a
JOIN categories c ON a.category_id = c.id;

-- Fonction pour incrémenter le compteur de vues de manière atomique
