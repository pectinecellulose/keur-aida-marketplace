...
const stats = [
  { value: "50K+", label: "Annonces" },
  { value: "15K+", label: "Utilisateurs" },
  { value: "25", label: "Catégories" },
      ...
      <div className="container mx-auto px-4 py-20 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative animate-slide-in-right">
            ...
            {/* Floating Stats Card */}
            <Card className="absolute -bottom-6 -left-6 lg:-left-12 bg-white/95 backdrop-blur-sm border-0 shadow-xl animate-float">
            ...
            <div className="absolute top-1/2 -left-8 w-16 h-16 rounded-full bg-gradient-to-br from-white/20 to-white/10 animate-float" style={{ animationDelay: '1s' }}></div>
          </div>
        </div>
      </div>
    </section>
